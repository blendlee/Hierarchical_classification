...
if __name__ == '__main__':
    ...
    parser.add_argument('--aux_model_dir',type=str,default='../Auxiliary_Task/models/..')
    ...
    train(args,auxiliary_model,primary_model,train_dataloader,dev_dataloader,test_dataloader)
